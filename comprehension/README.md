...
```
$ s2i build . seldonio/seldon-core-s2i-python3:0.7 cvdigital/reading_comp:<TAG>

$ docker push cvdigital/reading_comp:<TAG>
```

## Test

```
$ docker run --name "comprehension" --rm cvdigital/reading_comp:<TAG>
...
```
$ docker run --name "comprehension" --rm -p 5001:5000 cvdigital/reading_comp:<TAG>
